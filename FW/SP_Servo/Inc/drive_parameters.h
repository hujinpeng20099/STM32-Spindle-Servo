...
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,
                                                           absolute value */
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS 5 /*!< Number of speed
...
#define PID_TORQUE_KI_DEFAULT         280
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2200
#define PID_FLUX_KI_DEFAULT           280
...
#define PID_SPEED_KP_DEFAULT          2600/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          450 /*!< Over-voltage
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V          150 /*!< Under-voltage
                                                          threshold */
...
/******************************   START-UP PARAMETERS   **********************/
/* Encoder alignment */
#define ALIGNMENT_DURATION              800 /*!< milliseconds */
#define ALIGNMENT_ANGLE_DEG             300 /*!< degrees [0...359] */
#define FINAL_I_ALIGNMENT               6151 /*!< s16A */
