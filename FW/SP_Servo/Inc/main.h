...
/* USER CODE BEGIN EFP */
#define BUS_CTR_Pin GPIO_PIN_11
#define BUS_CTR_GPIO_Port GPIOA
/* USER CODE END EFP */
...
#define BUS_CTRL_Pin GPIO_PIN_11
#define BUS_CTRL_GPIO_Port GPIOA
