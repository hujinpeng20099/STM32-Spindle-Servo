...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, BUS_CTRL_Pin|LED_S_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RS_DE_GPIO_Port, RS_DE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : BUS_CTRL_Pin LED_S_Pin */
  GPIO_InitStruct.Pin = BUS_CTRL_Pin|LED_S_Pin;
...
/* USER CODE BEGIN MX_GPIO_Init_2 */
	HAL_Delay(3600);
	HAL_GPIO_WritePin(BUS_CTR_GPIO_Port, BUS_CTR_Pin, GPIO_PIN_SET);
